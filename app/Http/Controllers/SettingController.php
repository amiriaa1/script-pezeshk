...
class SettingController extends Controller
{
    public function emptyDatabase()
    {
        ...
        return redirect()->back()->with('message', 'پایگاه داده با موفقیت پاک شد');
    }
    ...
    public function generalSettingStore(Request $request)
    {
        ...
        return redirect()->back()->with('message', 'داده ها با موفقیت به روز شدند');
    }

    public function backup()
    {
        if(!env('USER_VERIFIED'))
            return redirect()->back()->with('not_permitted', 'این ویژگی برای نسخه ی نمایشی غیر فعال است!');
   ...
   //پیامک
    ...
    public function posSettingStore(Request $request)
    {
    	...
    	$pos_setting->save();
    	return redirect()->back()->with('message', 'تنظیم POS با موفقیت به روز شد');
    }
}
