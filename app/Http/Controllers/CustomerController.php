...
class CustomerController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if(isset($input['user'])) {
            ...
            $message = 'مشتری بروزرسانی شد و کاربر با موفقیت ایجاد شد';
        }
        else {
    ...
    public function importCustomer(Request $request)
    {
        ...
        if($role->hasPermissionTo('customers-add')){
            ...
            if($ext != 'csv')
                return redirect()->back()->with('not_permitted', 'لطفا یک فایل CSV آپلود کنید');
    ...
    public function getDeposit($id)
    {
        ...
        foreach ($lims_deposit_list as $deposit) {
            ...
            $date[] = $deposit->created_at->toTimeString();
    ...
    public function updateDeposit(Request $request)
    {
        ...
        return redirect('customer')->with('create_message', 'داده ها با موفقیت به روز شد');
    }
    ...
    public function deleteDeposit(Request $request)
    {
        ...
        return redirect('customer')->with('not_permitted', 'داده ها با موفقیت حذف شدند');
    }
