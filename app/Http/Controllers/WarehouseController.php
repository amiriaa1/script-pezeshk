...
class WarehouseController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('warehouse')->with('message', 'داده ها با موفقیت به روز شدند');
    }
    ...
    public function importWarehouse(Request $request)
    {
        ...
        return redirect('warehouse')->with('message', 'انبار با موفقیت وارد شد');
    }
    ...
    public function destroy($id)
    {
        ...
        $lims_warehouse_data->is_active = false;
        $lims_warehouse_data->save();
        return redirect('warehouse')->with('not_permitted', 'داده ها با موفقیت حذف شدند');
    }
}
