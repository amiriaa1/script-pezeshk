...
class CouponController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data['is_active'] = true;
        Coupon::create($data);
        return redirect('coupons')->with('message', 'تخفیف با موفقیت ایجاد شد ');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('coupons')->with('message', 'تخفیف با موفقیت بروزرسانی شد ');
    }
    ...
    public function destroy($id)
    {
        ...
        $lims_coupon_data->is_active = false;
        $lims_coupon_data->save();
        return redirect('coupons')->with('not_permitted', 'تخفیف با موفقیت حذف شد ');
    }
}
