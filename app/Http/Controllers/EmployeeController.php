...
class EmployeeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(isset($data['user'])){
            ...
            $message = 'کارمند با موفقیت ایجاد شد و به لیست کاربران اضافه شد';
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('employees')->with('message', 'کارمند با موفقیت به روز شد');
    }
    ...
    public function destroy($id)
    {
        ...
        $lims_employee_data->is_active = false;
        $lims_employee_data->save();
        return redirect('employees')->with('not_permitted', 'کارمند با موفقیت حذف شد');
    }
}
