...
class PayrollController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            $message = ' حقوق و دستمزد با موفقیت ایجاد شد.';
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('payroll')->with('message', 'حقوق و دستمزد با موفقیت به روز شد');
    }
    ...
    public function destroy($id)
    {
        $lims_payroll_data = Payroll::find($id);
        $lims_payroll_data->delete();
        return redirect('payroll')->with('not_permitted', 'حقوق و دستمزد با موفقیت حذف شد');
    }
}
