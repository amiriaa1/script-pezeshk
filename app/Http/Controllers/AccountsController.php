...
class AccountsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data['is_active'] = true;
        Account::create($data);
        return redirect('accounts')->with('message', 'حساب با موفقیت ایجاد شد');
    }
    ...
    public function makeDefault($id)
    {
        ...
        return 'حساب به عنوان پیش فرض با موفقیت تنظیم شد';
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('accounts')->with('message', 'حساب با موفقیت به روز شد');
    }
    ...
    public function destroy($id)
    {
        ...
        if(!$lims_account_data->is_default){
            ...
            $lims_account_data->save();
            return redirect('accounts')->with('not_permitted', 'حساب با موفقیت حذف شد!');
        }
        else
            return redirect('accounts')->with('not_permitted', 'لطفاً ابتدا حساب دیگری را پیش فرض قرار دهید!');
    }
}
