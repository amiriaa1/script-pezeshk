...
class TaxController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('tax')->with('message', 'داده ها با موفقیت به روز شدند');
    }
    ...
    {  
        ...
        return redirect('tax')->with('message', 'مالیات با موفقیت وارد شد');
    }
    ...
    public function destroy($id)
    {
        ...
        $lims_tax_data->is_active = false;
        $lims_tax_data->save();
        return redirect('tax')->with('not_permitted', 'داده ها با موفقیت حذف شدند');
    }
}
