...
class HolidayController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Holiday::create($data);
        return redirect()->back()->with('message', "تعطیلات با موفقیت ایجاد شد");
    }
    ...
    public function approveHoliday($id)
    {
        ...
        try {
            ...
            return 'برای تنظیمات رایانامه خود به منوی تنظیمات قسمت رایاناه مراجعه نمایید .';
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->back()->with('message', "تعطیلات با موفقیت به روز شد");
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->back()->with('not_prmitted', "تعطیلات با موفقیت حذف شد");
    }
}
