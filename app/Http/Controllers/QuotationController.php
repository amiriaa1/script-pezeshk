...
class QuotationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($lims_quotation_data->quotation_status == 2 && $mail_data['email']){
            try{
                ...
                $message = 'عملیات با موفقیت انجام شد ، جهت ارسال ایمیل به تنظیمات رایانامه خود مراجعه کنید .';
            } 
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($lims_quotation_data->quotation_status == 2 && $mail_data['email']){
            try{
                ...
                $message = 'عملیات با موفقیت بروزرسانی شد جهت ارسال ایمیل به قسمت تنظیمات رایانامه مراجعه کنید ';
            } 
        }
        return redirect('quotations')->with('message', $message);
    }
    ...
    public function destroy($id)
    {
        ...
        $lims_quotation_data->delete();
        return redirect('quotations')->with('not_permitted', 'قیمت با موفقیعت حذف شد');
    }
}
