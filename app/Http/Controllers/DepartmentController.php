...
class DepartmentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('departments')->with('message', 'بخش با موفقیت ایجاد شد ');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('departments')->with('message', 'بخش با موفقیت بروزرسانی شد ');
    }
    ...
    public function destroy($id)
    {
        ...
        $lims_department_data->is_active = false;
        $lims_department_data->save();
        return redirect('departments')->with('message', 'بخش با موفقیت حذف شد ');
    }
}
