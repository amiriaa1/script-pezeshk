...
class MoneyTransferController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->back()->with('message', 'انتقال پول با موفقیت انجام شد ');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->back()->with('message', 'انتقال پول با موفقیت به روز شد');
    }

    public function destroy($id)
    {
        MoneyTransfer::find($id)->delete();
        return redirect()->back()->with('not_permitted', 'داده ها با موفقیت حذف شدند');
    }
}
