    ...
    public function index()
    {
        ...
        while($start < $end)
        {
            ...
            $sent_amount = $sent_amount + $return_amount + $expense_amount + $payroll_amount;
                ...
                $iran=number_format((float)($recieved_amount + $purchase_return_amount), 2, '.', '');
                $iran2=substr($iran, 0, -3) ;

            
            
                $payment_recieved[] = $iran2; 
        ...
        while($start < $end)
        {
            ...
            if(Auth::user()->role_id > 2 && $general_setting->staff_access == 'own') {
                ...
                $iran=number_format((float)$sale_amount, 2, '.', '');
                                                
                $irannovin=substr($iran, 0, -3) ;
            
            $yearly_sale_amount[] = $irannovin;
