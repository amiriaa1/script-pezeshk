...
class CustomerGroupController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('customer_group')->with('message', 'داده ها با موفقیت به روز شد');
    }
    ...
    public function importCustomerGroup(Request $request)
    {
        ...
        return redirect('customer_group')->with('message', 'گروه مشتری با موفقیت وارد شد');
    ...
    public function destroy($id)
    {
        ...
        $lims_customer_group_data->is_active = false;
        $lims_customer_group_data->save();
        return redirect('customer_group')->with('not_permitted', 'داده ها با موفقیت حذف شدند');
    }
}
