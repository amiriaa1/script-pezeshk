...
class ExpenseCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('expense_categories')->with('message', 'داده با موفقیت درج شد');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('expense_categories')->with('message', 'داده ها با موفقیت به روز شدند');
    }
    ...
    public function import(Request $request)
    {
        ...
        if($ext != 'csv')
            return redirect()->back()->with('not_permitted', 'لطفاً یک پرونده اکسل بارگذاری کنید');
        ...
        return redirect('expense_categories')->with('message', 'دسته بندی هزینه را با موفقیت وارد شد ');
    }
    ...
    public function deleteBySelection(Request $request)
    {
        ...
        return 'گروه هزینه با موفقیت حذف شد!';
    }
    ...
    public function destroy($id)
    {
        ...
        $lims_expense_category_data->is_active = false;
        $lims_expense_category_data->save();
        return redirect('expense_categories')->with('not_permitted', 'داده ها با موفقیت حذف شدند');
    }
}
