...
class ExpenseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Expense::create($data);
        return redirect('expenses')->with('message', 'داده ها با موفقیت درج شد');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('expenses')->with('message', 'داده ها با موفقیت به روز شد');
    }
    ...
    public function destroy($id)
    {
        $lims_expense_data = Expense::find($id);
        $lims_expense_data->delete();
        return redirect('expenses')->with('not_permitted', 'داده ها با موفقیت حذف شدند');
    }
}
