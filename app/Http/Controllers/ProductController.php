...
class ProductController extends Controller
{
    ...
    public function updateProduct(Request $request)
    {
        if(!env('USER_VERIFIED')) {
            \Session::flash('not_permitted', 'این ویژگی برای نسخه ی نمایشی غیر فعال است!');
        }
        else {
            $this->validate($request, [
                'name' => [
            ...
            \Session::flash('edit_message', 'محصول با موفقیت به روز شد');
        }
    }
    ...
    public function search(Request $request)
    {
        ...
        $product[] = $lims_product_data->site;
        return $product;
    }
    ...
    public function importProduct(Request $request)
    {
        ...
        while($columns=fgetcsv($file))
        {
         ...
         return redirect('products')->with('import_message', 'محصول با موفقیت وارد شد');
    }
    ...
    public function destroy($id)
    {
        ...
        $lims_product_data->save();
        return redirect('products')->with('message', 'محصول با موفقیت حذف شد');
    }
}
