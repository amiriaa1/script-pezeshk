...
class SupplierController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('supplier')->with('message','داده ها با موفقیت به روز شدند');
    }
    ...
    public function destroy($id)
    {
        ...
        $lims_supplier_data->is_active = false;
        $lims_supplier_data->save();
        return redirect('supplier')->with('not_permitted','داده ها با موفقیت حذف شدند');
    }
    ...
    public function importSupplier(Request $request)
    {
        ...
        if($ext != 'csv')
            return redirect()->back()->with('not_permitted', 'لطفاً یک پرونده CSV بارگذاری کنید');
        ...
        while($columns=fgetcsv($file))
        {
           ...
           if($data['email']){
                try{
                    ...
                    $message = 'تأمین کننده با موفقیت وارد شد. ';
                }   
            }
        }
        return redirect('supplier')->with('message', $message); 
