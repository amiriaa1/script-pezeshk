...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('category')->with('message', 'دسته با موفقیت ثبت شد');
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect('category')->with('message', 'دسته با موفقیعت بروزرسانی شد ');
    }
    ...
    public function import(Request $request)
    {
        ...
        return redirect('category')->with('message', 'دسته با موفقیت وارد شد');
    }
    ...
    public function destroy($id)
    {
        ...
        if($lims_category_data->image)
            unlink('public/images/category/'.$lims_category_data->image);
        $lims_category_data->save();
        return redirect('category')->with('not_permitted', 'دسته با موفقیت حذف شد');
    }
}
