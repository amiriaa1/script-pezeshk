                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row">  
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>{{trans('file.Attach Document')}}</label> <i class="dripicons-question" data-toggle="tooltip"  style="    font-family: 'Shabnam';" title="jpg, jpeg, png, gif, pdf, csv, docx, xlsx  فایل مجـــاز"></i>
                                    ...
                                    <div class="col-md-12 mt-3">
                                        ...
                                        <div class="search-box input-group">
                                            ...
                                            <input  type="text"   name="product_code_name" id="lims_productcodeSearch"  placeholder="لطفا کد کالا را وارد کنید ..." class="form-control"  style="font-family: 'Shabnam'"/>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="paid_amount" value="0.0" />
...
$('#purchase-form').on('submit',function(e){
    ...
    else if($('select[name="status"]').val() != 1)
    {
        ...
        if(!flag){
            alert('مقدار و مقدار دریافت شده یکسان است! لطفاً وضعیت خرید یا مقدار دریافتی را تغییر دهید');
            e.preventDefault();
        }
    }
});
