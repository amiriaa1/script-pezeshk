                                    ...
                                    <div class="row">
                                        ...
                                        <div id="start_date" class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="starting_date" value="{{$lims_product_data->starting_date}}" id="input1" class="form-control form-control-sm" />
                                            </div>
                                        </div>
                                        <div id="last_date" class="col-md-4">
                                            <div class="form-group">
                                                <label>{{trans('file.Promotion Ends')}}</label>
                                                <input type="text" name="last_date" value="{{$lims_product_data->last_date}}" id="input1" class="form-control form-control-sm" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
