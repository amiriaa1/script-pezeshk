                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                    <button type="submit" class="btn btn-link" onclick="آیا مطمئن هستید می خواهید حذف کنید ؟"><i class="dripicons-trash"></i> {{trans('file.delete')}}</button>
                                </li>
                                {{ Form::close() }}
                            </ul>
                        </div>
        ...
        <div class="modal-body">
          <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
            <div class="form-group">
                ...
                {{Form::text('name',null,array('required' => 'required', 'class' => 'form-control', 'placeholder' => 'نام ارز را تایپ کنید ...'))}}
            </div>
            <div class="form-group">
                <label>{{trans('file.Code')}} *</label>
                {{Form::text('code',null,array('required' => 'required', 'class' => 'form-control', 'placeholder' => 'کد ارز را تایپ کنید ...'))}}
            </div>
            <div class="form-group">
                <label>{{trans('file.Exchange Rate')}} *</label>
                {{Form::text('exchange_rate',null,array('required' => 'required', 'class' => 'form-control', 'placeholder' => 'نرخ ارز را تایپ کنید ...'))}}
            </div>                
            <div class="form-group">       
