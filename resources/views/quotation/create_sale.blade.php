                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select required name="customer_id" class="selectpicker form-control" data-live-search="true" id="customer_id" data-live-search-style="begins" title="مشتری را انتخاب کنید ...">
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                    ...
                                                    ?>
                                                        ...
                                                        <td class="net_unit_price">
                                                            ...
                                                            <?php
                                                                    ...
                                                                    $iran=number_format((float)$product_quotation->net_unit_price, 2, '.', '');
                                                        ...
                                                        <td class="tax">
                                                                    ...
                                                                    $iran= number_format((float)$product_quotation->tax, 2, '.', '');
                                                        ...
                                                        <td class="sub-total">
                                                           ...
                                                           <?php
                                                             $iran= number_format((float)$product_quotation->total, 2, '.', '');
                                                            echo     substr($iran, 0, -3) ;
                                                            ?>
                                                        ...
                                                        @else
                                                        <input type="hidden" class="tax-name" value="عدم مالیات" />
                                                        @endif
                                                ...
                                                <tfoot class="tfoot active">
                                                    ...
                                                    <th id="total-tax">
                                                      ...
                                                      <?php
                                                       $iran= number_format((float)$lims_quotation_data->total_tax, 2, '.', '');
                                                      echo     substr($iran, 0, -3) ;
                                                      ?>
                                                    ...
                                                    <th id="total">
                                                     ...
                                                     <?php
                                                       $iran= number_format((float)$lims_quotation_data->total_price, 2, '.', '') ;
                                                      echo     substr($iran, 0, -3) ;
                                                      ?>
