...
<section class="forms">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select required name="biller_id" class="selectpicker form-control" data-live-search="true" id="biller-id" data-live-search-style="begins" title=" انتخاب فروشنده...">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="customer_id" name="customer_id" required class="selectpicker form-control" data-live-search="true" id="customer-id" data-live-search-style="begins" title="انتخاب مشتری...">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="warehouse_id" name="warehouse_id" required class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="انتخاب انبار ...">
		                                ...
		                                <div class="table-responsive mt-3">
		                                    <table id="myTable" class="table table-hover order-list">
		                                        ...
		                                        <tfoot class="tfoot active">
		                                            ...
		                                            <th></th>
		                                            <th id="total-discount">0.0</th>
		                                            <th id="total-tax">0.0</th>
		                                            <th id="total">0.0</th>
		                                            <th><i class="dripicons-trash"></i></th>
		                                        </tfoot>
		                                    </table>
  ...
  <div class="container-fluid">
        <table class="table table-bordered table-condensed totals">
            ...
            <td style="    background-color: #fff;text-align: center;"><strong style="font-weight: 100;">{{trans('جمع مبلغ کل')}}</strong><br>
...
function checkQuantity(sale_qty, flag) {
    ...
    if(product_type[pos] == 'standard'){
        ...
        if (total_qty > parseFloat(product_qty[pos])) {
            alert('مقدار بیش از مقدار انبار است!');
            if (flag) {
