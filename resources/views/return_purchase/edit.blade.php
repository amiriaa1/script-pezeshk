                                ...
                                <div class="row">
                                      ...
                                      <div class="col-md-4">
                                        <div class="form-group" >
                                           <label>{{trans('file.reference')}}</label>
                                            <p><strong style="color: #1e7e34;">{{ $lims_return_data->reference_no }}</strong></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select required id="warehouse_id" name="warehouse_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title=" انتخاب انبار...">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="supplier_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title=" انتخاب تامین کننده...">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select required id="account_id" name="account_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title=" انتخاب کــاربر...">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <?php
                                                            ...
                                                            $iran=number_format((float)$product_return->net_unit_cost, 2, '.', '');
                                                        ...
                                                        <?php
                                                            ...
                                                            $iran= number_format((float)$product_return->discount, 2, '.', '');
                                                        ...
                                                        <td class="tax">
                                                          ...
                                                          <?php
                                                            ...
                                                            $iran= number_format((float)$product_return->tax, 2, '.', '') ;
                                                        ...
                                                        <td class="sub-total">
                                                           ...
                                                           <?php
                                                            ...
                                                            $iran= number_format((float)$product_return->total, 2, '.', '');
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="order_tax_rate">
                                                <option value="0">عــدم مالیات</option>
                                	...
                                	<div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <i class="dripicons-question" data-toggle="tooltip" title=" jpg, jpeg, png, gif, pdf, csv, docx, xlsx فایل مجـــاز"></i> 
...
function calculateRowProductData(quantity) {
    ...
    if (tax_method[rowindex] == 1) {
        ...
        $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('td:nth-child(4)').text(net_unit_cost.toFixed(0));
...
$('.payment-form').on('submit',function(e){
    var rownumber = $('table.order-list tbody tr:last').index();
    if (rownumber < 0) {
        alert("اطلاعات بیشتر درباره این نوشتار مبدأ")
        e.preventDefault();
    }
});
