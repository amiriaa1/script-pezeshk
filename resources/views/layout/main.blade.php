            ...
            <ul id="side-main-menu" class="side-menu list-unstyled">                  
              ...
              <li><a href="#sale" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-cart"></i><span>{{trans('file.Sale')}}</span></a>
                <ul id="sale" class="collapse list-unstyled ">
                  ...
                  <li id="sale-list-menu"><a href="{{route('sales.index')}}">{{trans('file.Sale List')}}</a></li>
                    ...
                    <li><a href="{{route('sale.pos')}}">پایانه فروش</a></li>
              ...
              <li><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-gear"></i><span>{{trans('file.settings')}}</span></a>
                <ul id="setting" class="collapse list-unstyled ">
                  ...
                  <li id="pos-setting-menu"><a href="{{route('setting.pos')}}">پایانامه فروش {{trans('file.settings')}}</a></li>
                  @endif
        ...
        <nav class="navbar" style="background: #304967;">
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <span class="brand-big" style="position: absolute;    transform: translateX(-0%);    right: 7%;">@if($general_setting->site_logo)<img src="{{url('public/logo', $general_setting->site_logo)}}" width="50">&nbsp;&nbsp;@endif<a href="{{url('/')}}"><h1 class="d-inline" style="font-size:12px;color: #f6f8fb;">{{$general_setting->site_title}}</h1></a></span>
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                ...
                @if(\Auth::user()->role_id <= 2)
                  <li class="nav-item"><a href="{{route('cashRegister.index')}}" title="{{trans('file.Cash Register List')}}"><i class="dripicons-archive" style="#f7f8fb"></i></a></li>
                @endif
                @if($product_qty_alert_active)
                  @if(($alert_product + count(\Auth::user()->unreadNotifications)) > 0)
                  <li class="nav-item" id="notification-icon">
                        <a rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-item" style="    color: #f6f8fb;"><i class="dripicons-bell"></i><span class="badge badge-danger notification-number" style="    color: #f6f8fb;">{{$alert_product + count(\Auth::user()->unreadNotifications)}}</span>
                        </a>
                        <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default notifications" user="menu">
                            <li class="notifications">
                              <a href="{{route('report.qtyAlert')}}" class="btn btn-link"> {{$alert_product}} محصول بیش از مقدار هشدار است</a>
                            </li>
                ...
                @endif
                <li class="nav-item">
                  <a rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-item"><i class="dripicons-user" style="    color: #ff7588;" ></i> <span style="color: #f7f8fb;">{{ucfirst(Auth::user()->name)}}</span> <i class="fa fa-angle-down"></i>
                  </a>
                  <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                      ...
                      <li>
                        <a onclick="return confirm('آیا مطمئن هستید که می خواهید حذف کنید؟ اگر این کار را انجام دهید ، تمام داده های شما از بین می رود.')" href="{{route('setting.emptyDatabase')}}"><i class="dripicons-stack"></i> {{trans('file.Empty Database')}}</a>
                      </li>
                      @endif
                      <li>
                        <a href="{{ route('logout') }}"
