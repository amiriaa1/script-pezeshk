                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td class="net_unit_price">
                                                            ...
                                                            <?php
                                                                $iran=number_format((float)$product_sale->net_unit_price, 2, '.', '');
                                                        ...
                                                        <td class="discount">
                                                                 ...
                                                                 <?php
                                                                $iran=number_format((float)$product_sale->discount, 2, '.', '');
                                                        ...
                                                        <td class="tax">
                                                                 ...
                                                                 <?php
                                                                $iran=number_format((float)$product_sale->tax, 2, '.', '');
                                                        ...
                                                        <td class="sub-total">
                                                                    ...
                                                                    <?php
                                                                $iran=number_format((float)$product_sale->total, 2, '.', '');
                                                ...
                                                <tfoot class="tfoot active">
                                                    ...
                                                    <th id="total-discount">
                                                                      ...
                                                                      <?php
                                                                $iran=number_format((float)$lims_sale_data->total_discount, 2, '.', '') ;
                                                    ...
                                                    <th id="total-tax">
                                                                    ...
                                                                    <?php
                                                                $iran=number_format((float)$lims_sale_data->total_tax, 2, '.', '');
