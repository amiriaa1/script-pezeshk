...
<section class="forms">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="italic"><small>{{trans('فیلدی که با * مشخص شده اند ، فیلدهای ورودی الزامی هستند')}}.</small></p>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select required name="customer_id" id="customer_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="مشتری را انتخاب کنید ...">
                                                <?php $deposit = []; ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select required name="warehouse_id" id="warehouse_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="انتخاب انبار ...">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select required name="biller_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="انتخاب فروشنده ...">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="order_tax_rate">
                                                <option value="0">عدم مالیات</option>
    ...
    <div class="container-fluid">
        <table class="table table-bordered table-condensed totals">
            <td style="    background-color: #fff;text-align: center;"><strong style="font-weight: 100;">{{trans('تعداد محصول')}}</strong><br>
                <span class="pull-right" id="item" style="text-align: center;    float: none;">0.0</span>
            </td>
            <td style="    background-color: #fff;text-align: center;"><strong style="font-weight: 100;">{{trans('مبلغ کل')}}</strong><br>
                <span class="pull-right" id="subtotal" style="text-align: center;    float: none;">0.0</span>
            </td>
            <td style="    background-color: #fff;text-align: center;" ><strong style="font-weight: 100;">{{trans('جمع مالیات')}}</strong><br>
                <span class="pull-right" id="order_tax" style="text-align: center;    float: none;">0.0</span>
            </td>
            <td style="    background-color: #fff;text-align: center;"><strong style="font-weight: 100;">{{trans('مبلغ تخفیف')}}</strong><br>
                <span class="pull-right" id="order_discount" style="text-align: center;    float: none;">0.0</span>
            </td>
            <td style="    background-color: #fff;text-align: center;"><strong style="font-weight: 100;">{{trans('file.Shipping Cost')}}</strong><br>
                <span class="pull-right" id="shipping_cost" style="text-align: center;    float: none;">0.0</span>
            </td>
            <td style="    background-color: #fff;text-align: center;background-color: rgba(142,213,87,.2);    color: #8ed557;font-weight: 100;"><strong>{{trans('جمع مبلغ کــل')}}</strong><br>
    ...
    <div id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                ...
                <h5 id="modal_header" class="modal-title" style="color:#ffd06d;font-weight: 100;"></h5>
                </div>
...
function checkQuantity(sale_qty, flag) {
    ...
    if(product_type[pos] == 'standard'){
        ...
        if (total_qty > parseFloat(product_qty[pos])) {
            alert('مقدار از مقدار موجودی بیشتر است!');
            if (flag) {
...
function calculateRowProductData(quantity) {
    ...
    $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('td:nth-child(5)').text((product_discount[rowindex] * quantity).toFixed(0));
    ...
    if (tax_method[rowindex] == 1) {
        ...
        $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('td:nth-child(4)').text(net_unit_price.toFixed(0));
        $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.net_unit_price').val(net_unit_price.toFixed(0));
        $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('td:nth-child(6)').text(tax.toFixed(0));
        $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.tax-value').val(tax.toFixed(0));
        $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('td:nth-child(7)').text(sub_total.toFixed(0));
    ...
    if(id == 2) {
        ...
        if (id == 6){
            if($('input[name="paid_amount"]').val() > deposit[$('#customer_id').val()]){
                alert('مبلغ از سپرده مشتری بیشتر است! سپرده مشتری: '+ deposit[$('#customer_id').val()]);
            }
        }
    }
});
...
$('select[name="gift_card_id"]').on("change", function() {
    ...
    if($('input[name="paid_amount"]').val() > balance){
        alert('مبلغ بیش از موجودی کارت است! موجودی کارت هدیه: '+ balance);
    }
});
...
$('input[name="paid_amount"]').on("input", function() {
    if( $(this).val() > parseFloat($('input[name="paying_amount"]').val()) ) {
        ...
        alert('مبلغ پرداختی نمی تواند بیشتر از کل کل باشد');
        $(this).val('');
    }
...
$(document).on('submit', '.payment-form', function(e) {
    ...
    if ( rownumber < 0 ) {
        ...
        alert('مبلغ پرداختی برابر است با کل کل! لطفا وضعیت پرداخت را تغییر دهید.');
        e.preventDefault();
    }
    else
        $("#paid-amount").prop('disabled',false);
