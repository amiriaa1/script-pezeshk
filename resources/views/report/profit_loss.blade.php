		...
		<div class="row mt-4">
			...
			<div class="col-md-3">
				<div class="colored-box">
					...
					<hr>
					<div class="mt-3">
						<p class="mt-2" >{{trans('file.Amount')}}: <span style="    color: #09abb3;"> 
						<?php
						 $iran=number_format($purchase[0]->grand_total, 2);
                         echo     substr($iran, 0, -3).' '.config('currency'); ;
						?>
						</span></p>
						<p class="mt-2">{{trans('file.Purchase')}}: <span style="    color: #09abb3;">{{$total_purchase}}</span></p>
						<p class="mt-2">{{trans('file.Paid')}} : <span style="    color: #09abb3;" >
						...
						<p class="mt-2">{{trans('file.Tax')}} : <span style="    color: #09abb3;">
			...
			<div class="col-md-3">
				<div class="colored-box">
					...
					<div class="mt-3">
						...
						<p class="mt-2">{{trans('file.Sale')}} :<span style="    color: #09abb3;">{{$total_sale}}</span></p>
						<p class="mt-2">{{trans('file.Paid')}} :<span style="    color: #09abb3;">
			...
			<div class="col-md-3">
				<div class="colored-box">
					...
					<div class="mt-3">
						...
						<p class="mt-2">{{trans('file.Return')}}: <span style="    color: #09abb3;">{{$total_return}}
			...
			<div class="col-md-3">
				<div class="colored-box">
					...
					<div class="mt-3">
						...
						<p class="mt-2">{{trans('file.Return')}}: <span style="    color: #09abb3;">
		...
		<div class="row mt-2">
			<div class="col-md-4">
				<div class="colored-box">
					...
					<hr>
					<div class="mt-3">
						<p class="mt-2">{{trans('file.Sale')}} :<span  style="    color: #09abb3;">
						...
						<p class="mt-2">{{trans('file.Purchase')}}: <span  style="    color: #09abb3;"> 
						...
						<p class="mt-2">{{trans('file.profit')}} :<span  style="    color: #09abb3;"> 
			...
			<div class="col-md-4">
				<div class="colored-box">
					...
					<div class="mt-3">
						...
						<p class="mt-2">{{trans('file.Sale Return')}} :<span  style="    color: #09abb3;">
						...
						<p class="mt-2">{{trans('file.Purchase Return')}}: <span style="    color: #09abb3;"> 
			...
			<div class="col-md-4">
				<div class="colored-box">
					<i class="fa fa-money "></i>
					<h3>{{trans('file.Net Profit')}} / {{trans('file.Net Loss')}}
		...
		<div class="row mt-2">
			<div class="col-md-3">
				<div class="colored-box">
					...
					<div class="mt-3">
						...
						<p class="mt-2">{{trans('file.Recieved')}}: <span style="    color: #09abb3;">{{$payment_recieved_number}}
			...
			<div class="col-md-3">
				<div class="colored-box">
					...
					<div class="mt-3">
						...
						<p class="mt-2">{{trans('file.Recieved')}}: <span  style="    color: #09abb3;" >
						    
						    
						    
						    {{$payment_sent_number}}</span></p>
			...
			<div class="col-md-3">
				<div class="colored-box">
					...
					<div class="mt-3">
						...
						<p class="mt-2">{{trans('file.Expense')}}: <span  style="    color: #09abb3;"> 
			...
			<div class="col-md-3">
             ...
             $iran2=substr($iran, 0, -3)  ;
						...
						<p class="mt-2">{{trans('file.Payroll')}}: <span  style="    color: #09abb3;"> 
			...
			<div class="col-md-4 offset-md-4">
				<div class="colored-box">
					...
					<div class="mt-3">
						...
						<p class="mt-2">{{trans('file.Sent')}}: <span style="    color: #09abb3;"> 
						...
						<p class="mt-2">{{trans('file.In Hand')}}: <span style="    color: #09abb3;"> 
