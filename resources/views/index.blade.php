          ...
          <div class="row">
            ...
            <div class="col-md-12 form-group" style="    margin-top: 20px;">
              ...
              <div class="row">
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center" style="background: linear-gradient(0deg,#82c94a,#9fe16b) ;    padding: 0px 1px;">
                    <div class="icon"><i class="dripicons-graph-bar" style="color: #fff;"></i></div>
                    <div class="name"><strong style="color: #fff;font-size: 12px;">{{ trans('مجموع کل فروش ها') }}</strong></div>
                    <div class="count-number revenue-data" style="color: #fff;    font-size: 17px;">
                    <?php
                ...
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center" style="    background: linear-gradient(0deg,#ffb341,#ffcc5e);    padding: 0px 1px;">
                    <div class="icon"><i class="dripicons-return" style="color: #fff"></i></div>
                    <div class="name"><strong style="color: #fff;font-size: 12px;">{{trans('file.Sale Return')}}</strong></div>
                    <div class="count-number return-data" style="color: #fff;    font-size: 17px;">
                ...
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center"style="background:linear-gradient(30deg, #DB9439 0%, #FE5B84 58%);   padding: 0px 1px;">
                    <div class="icon"><i class="dripicons-media-loop" style="color: #fff"></i></div>
                    <div class="name"><strong style="color: #fff;font-size: 12px;">{{trans('file.Purchase Return')}}</strong></div>
                    <div class="count-number purchase_return-data" style="color: #fff;    font-size: 17px;">
                         <?php
                ...
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center" style="background-color: #17a2b8;  padding: 0px 1px;">
                    <div class="icon"><i class="dripicons-trophy" style="color: #fff"></i></div>
                    <div class="name"><strong style="color: #fff;font-size: 12px;">{{trans('file.profit')}}</strong></div>
                    <div class="count-number profit-data" style="color: #fff;    font-size: 17px;">
            ...
            <div class="col-md-7 mt-4">
              <div class="card line-chart-example">
                ...
                <div class="card-body">
                  ...
                  <canvas id="cashFlow" 
                  data-color = "{{$color}}" 
                  data-color_rgba = "{{$color_rgba}}" data-recieved = "{{json_encode($payment_recieved)}}" 
            ...
            <div class="col-md-5 mt-4">
              <div class="card">
                ...
                <div class="pie-chart mb-2" style="    font-family: 'Shabnam';">
                    
                    <canvas id="transactionChart"
                    data-color = "{{$color}}" data-color_rgba = "{{$color_rgba}}" 
                    data-revenue={{$revenue}} 
                    data-purchase={{$purchase}}
                    data-expense={{$expense}}
                    data-label1="{{trans('file.Purchase')}}" 
                    data-label2="{{trans('file.revenue')}}"
                    data-label3="{{trans('file.Expense')}}"
              ...
              <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center" >
                  ...
                  <div class="right-column">
                    <div class="badge badge-primary">5 {{trans('file.latest')}} </div>
                  </div>
                </div>
...
?>
 ...
 if ($payment->paying_method == "Gift Card") {
            ...
            <div class="col-md-5">
              <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                  <h4>{{trans('file.Best Seller').' '. '('.trans('file.price').')'}}</h4>
                  <div class="right-column">
