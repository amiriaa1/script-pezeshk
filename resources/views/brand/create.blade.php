                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                    <button type="submit" class="btn btn-link" onclick="return confirm('آیا مطمئن هستید که می خواهید حذف کنید؟')"><i class="dripicons-trash"></i> {{trans('file.delete')}}</button>
                                </li>
                                {{ Form::close() }}
                            </ul>
                        </div>
        ...
        <div class="modal-body">
          <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
            <div class="form-group">
                ...
                {{Form::text('title',null,array('required' => 'required', 'class' => 'form-control', 'placeholder' => 'عنوان برند را وارد کنید....'))}}
            </div>
            <div class="form-group">
