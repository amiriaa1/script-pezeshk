                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <?php
                                                         ...
                                                         $iran= number_format((float)$product_transfer->net_unit_cost, 2, '.', '');
                                                       ...
                                                       echo     substr($iran, 0, -3) ;
                                                        ...
                                                        <?php
                                                            $iran=number_format((float)$product_transfer->tax, 2, '.', '');
                                                        ...
                                                        <td class="sub-total">
                                                         ...
                                                         <?php
                                                            $iran=number_format((float)$product_transfer->total, 2, '.', '') ;
                                                ...
                                                <tfoot class="tfoot active">
                                                    ...
                                                    <?php
                                                        ...
                                                        $iran=number_format((float)$lims_transfer_data->total_tax, 2, '.', '');
                                                    ...
                                                    <th id="total">
                                                     ...
                                                     <?php
                                                        ...
                                                        $iran=number_format((float)$lims_transfer_data->total_cost, 2, '.', '');
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <i class="dripicons-question" data-toggle="tooltip" title=" jpg, jpeg, png, gif, pdf, csv, docx, xlsx  فایل هیا مجاز"></i> 
...
function calculateRowProductData(quantity) {
    ...
    if (tax_method[rowindex] == 1) {
        ...
        $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('td:nth-child(5)').text(tax.toFixed(0));
        $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.tax-value').val(tax.toFixed(0));
        $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('td:nth-child(6)').text(sub_total.toFixed(0));
...
$('#transfer-form').on('submit',function(e){
    ...
    if($('select[name="from_warehouse_id"]').val() == $('select[name="to_warehouse_id"]').val()){
        alert('هر دو انبار نمی توانند یکسان باشند!');
        e.preventDefault();
        $('select[name="from_warehouse_id"]').prop('disabled', true);
    }
});
