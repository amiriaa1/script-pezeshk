                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" >
                                            ...
                                            <p><strong style="    color: #f18a3c;    font-weight: 100;">{{ $lims_return_data->reference_no }}</strong></p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <?php 
                                                            $iran=(number_format((float)$product_return->net_unit_price, 2, '.', ''));
                                                ...
                                                <tfoot class="tfoot active">
                                                    ...
                                                    <th id="total-discount">
                                                      ...
                                                      <?php 
                                                     $iran=( number_format((float)$lims_return_data->total_discount, 2, '.', ''));
                                                    ...
                                                    <th id="total-tax">
                                                               ...
                                                               <?php 
                                                     $iran=(number_format((float)$lims_return_data->total_tax, 2, '.', ''));
                                                    ...
                                                    <th id="total">
                                                                      ...
                                                                      <?php 
                                                     $iran=( number_format((float)$lims_return_data->total_price, 2, '.', ''));
