            ...
            <div class="modal-body">
                ...
                <form>
                    ...
                    <div class="form-group operator">
                        <label>{{trans('file.Operator')}}</label> <input type="text" name="operator"  style="font-family: 'Shabnam';" placeholder="نام را وارد کنید" class="form-control" />
                    </div>
                    <div class="form-group operation_value">
                        <label>{{trans('file.Operation Value')}}</label><input type="number" style="font-family: 'Shabnam';" name="operation_value" placeholder="مقدار عملکرد را وارد کنید" class="form-control" step="any"/>
                    </div>
        ...
        <div class="modal-body">
          <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
            <form>
                ...
                <div class="form-group operator">
                    <label>{{trans('file.Operator')}}</label> <input type="text" name="operator" placeholder="نام را وارد کنید" class="form-control" />
                </div>
                <div class="form-group operation_value">
                    <label>{{trans('file.Operation Value')}}</label><input type="number" name="operation_value" placeholder="مقدار عملکرد را وارد کنید" class="form-control" step="any"/>
                </div>
                <input type="submit" value="{{trans('file.submit')}}" class="btn btn-primary">
            </form>
        </div>
