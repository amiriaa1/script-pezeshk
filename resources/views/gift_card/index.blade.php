          ...
          <div class="modal-body">
              <div class="gift-card" style="margin: 0 auto; max-width: 350px; position: relative; color:#fff;"><img src="{{url('public/images/gift_card/front.jpg')}}" width="350" height="200">
                <div style="position: absolute; padding: 15px; top:0; left: 0; width: 350px;">
                    <h3 class="d-inline">کارت هدیه</h3><h3 class="d-inline float-right">{{$general_setting->currency}} <span id="balance"></span></h3>
  ...
  <div role="document" class="modal-dialog">
      <div class="modal-content">
          <div class="modal-header">
              ...
              <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
               <h5 id="exampleModalLabel" class="modal-title" style="color: #f18a3c;    font-weight: 100;"> {{trans('file.Card No')}}: <span id="card-no"></span></h5>
          </div>
          <div class="modal-body">
            <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
