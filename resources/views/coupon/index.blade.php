...
<section>
    <div class="container-fluid">
        <button class="btn btn-info" data-toggle="modal" data-target="#create-modal">
            <i class="dripicons-plus"></i> {{trans('file.Add Coupon')}}</button>
    </div>
        ...
        <table id="coupon-table" class="table" style="width: 100%";>
            ...
            <tbody>
             ...
             ?>
                    ...
                    @else
                    <td class="text-center"><div class="badge badge-danger">{{ $coupon->quantity - $coupon->used }}
