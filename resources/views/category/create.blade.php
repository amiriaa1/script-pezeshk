          ...
          <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
            <div class="row">
                <div class="col-md-6 form-group">
                    <label>{{trans('file.name')}} *</label><p> 
                    {{Form::text('name',null,array('required' => 'required', 'class' => 'form-control', 'placeholder' => 'نوع دسته بندی ...'))}}
                </div>
                <div class="col-md-6 form-group">
                ...
                <div class="col-md-6 form-group">
                    ...
                    {{Form::select('parent_id', $lims_categories, null, ['class' => 'form-control','placeholder' => 'عدم عنوان دسته بندی'])}}
                </div> 
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 form-group">
                ...
                <select name="parent_id" class="form-control selectpicker" id="parent">
                    <option value="">عدم {{trans('file.parent')}}</option>
