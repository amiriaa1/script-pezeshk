          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                ...
                ?>
                <?php if($add_permission_active): ?>
                <li class="nav-item"><a class="dropdown-item btn-pos btn-sm" href="<?php echo e(route('sale.pos')); ?>"><i class="dripicons-shopping-bag"></i><span> پایانه فروش</span></a></li>
                <?php endif; ?>      
                ...
                <?php if(Auth::user()->role_id != 5): ?>
                <li class="nav-item"> 
                    <a class="dropdown-item" href="http://edogroup.ir/edosale" target="_blank"><i class="dripicons-information"></i> <?php echo e(trans('file.Help')); ?></a>
                </li>
                <?php endif; ?>
                <li class="nav-item">
...
</html><?php /**PATH /home/edomeir/public_html/edosale_new/resources/views/layout/main.blade.php ENDPATH**/ ?>