...
<section class="forms">
    ...
    $iran=number_format((float)($product->qty), 2, '.', '');
    ...
    $iran=number_format((float)($product->alert_quantity), 2, '.', '');
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/edogroup/edosale.edogroup.ir/resources/views/report/qty_alert_report.blade.php ENDPATH**/ ?>