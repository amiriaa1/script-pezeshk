...
?>
       ...
       $iran= $return->created_at->toDateString();
       ...
       list($gy, $gm, $gd) = explode('-', ($iran));
		...
		$j_date_string = gregorian_to_jalali($gy, $gm, $gd, '/'); //خروجی رشته
                   ...
                   echo $j_date_string;
                    ...
                    ?> <?php echo e(' '. $return->created_at->toTimeString()); ?></td>
            ...
            },
            {
                ...
                action: function ( e, dt, node, config ) {
                    if(user_verified == '1') {
                        ...
                        if(return_id.length && confirm("آیا مطمئن هستید که می خواهید حذف کنید؟")) {
                            $.ajax({
                                type:'POST',
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/edogroup/edosale.edogroup.ir/resources/views/return/index.blade.php ENDPATH**/ ?>