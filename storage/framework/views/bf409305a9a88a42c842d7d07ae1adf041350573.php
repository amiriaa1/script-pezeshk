    ...
    <div class="table-responsive mb-4">
        <table id="account-table" class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="color:#ff0ccb">
                     
                    
                    <?php
                    
                    $iran=number_format($credit[$key], 2);
     ...
     echo     substr($iran, 0, -3)  .' '.config('currency');
                    ...
                    <td style="color:#7c5cc4">
                             ...
                             <?php
                             $iran=number_format($debit[$key], 2);
     ...
     echo     substr($iran, 0, -3) .' '.config('currency');
                    ...
                    <td style="color:#fd6a17">
                    
                      <?php
                        $iran=number_format($credit[$key] - $debit[$key], 2);
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/edomeir/public_html/edosale_new/resources/views/account/balance_sheet.blade.php ENDPATH**/ ?>