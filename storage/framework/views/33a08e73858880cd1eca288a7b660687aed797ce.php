          ...
          <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
            <div class="row">
                <div class="col-md-6 form-group">
                    <label><?php echo e(trans('file.name')); ?> *</label><p> 
                    <?php echo e(Form::text('name',null,array('required' => 'required', 'class' => 'form-control', 'placeholder' => 'نوع دسته بندی ...'))); ?>
                ...
                <div class="col-md-6 form-group">
                    ...
                    <?php echo e(Form::select('parent_id', $lims_categories, null, ['class' => 'form-control','placeholder' => 'عدم عنوان دسته بندی'])); ?>
        ...
        <div class="row">
            ...
            <div class="col-md-6 form-group">
                ...
                <select name="parent_id" class="form-control selectpicker" id="parent">
                    <option value="">عدم <?php echo e(trans('file.parent')); ?></option>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/edogroup/edosale.edogroup.ir/resources/views/category/create.blade.php ENDPATH**/ ?>