			...
			<div class="card-body"> 
				...
				<div class="table-responsive mt-4">
					<table class="table table-bordered" style="border-top: 1px solid #dee2e6; border-bottom: 1px solid #dee2e6;">
					    ...
					    <tbody>
						    <tr>
						      <td><strong>فروردین</strong></td>
						      <td><strong>اردیبهشت</strong></td>
						      <td><strong>خرداد</strong></td>
						      <td><strong>تیر</strong></td>
						      <td><strong>مرداد</strong></td>
						      <td><strong>شهریور</strong></td>
						      <td><strong>مهر</strong></td>
						      <td><strong>آبان</strong></td>
						      <td><strong>آذر</strong></td>
						      <td><strong>دی</strong></td>
						      <td><strong>بهمن</strong></td>
						      <td><strong>اسفند</strong></td>
						    </tr>
						    <tr>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/edomeir/public_html/salepro/resources/views/report/monthly_purchase.blade.php ENDPATH**/ ?>