...
<section>
  ...
  $iran=number_format($account->initial_balance, 2);
              ...
              <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                <?php echo Form::open(['route' => ['accounts.update', 1], 'method' => 'put']); ?>
                    ...
                    <div class="form-group">
                        <label> شماره <?php echo e(trans('file.Account')); ?> *</label>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/edomeir/public_html/edosale_new/resources/views/account/index.blade.php ENDPATH**/ ?>