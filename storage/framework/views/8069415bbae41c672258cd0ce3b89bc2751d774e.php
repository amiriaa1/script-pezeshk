                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row">  
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><?php echo e(trans('file.Attach Document')); ?></label> <i class="dripicons-question" data-toggle="tooltip"  style="    font-family: 'Shabnam';" title="jpg, jpeg, png, gif, pdf, csv, docx, xlsx  فایل مجـــاز"></i>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/edogroup/edosale.edogroup.ir/resources/views/purchase/create.blade.php ENDPATH**/ ?>