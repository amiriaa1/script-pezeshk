...
<section>
    <div class="container-fluid">
        <button class="btn btn-info" data-toggle="modal" data-target="#create-modal">
            <i class="dripicons-plus"></i> <?php echo e(trans('file.Add Coupon')); ?></button>
    </div>
        ...
        <table id="coupon-table" class="table" style="width: 100%";>
            ...
            <tbody>
                ...
                <tr data-id="<?php echo e($coupon->id); ?>">
                    ...
                    <?php
                      $iran=number_format( $coupon->amount, 2);
             ...
             ?>
                    ...
                    <td><?php echo e($coupon->minimum_amount); ?>
                    ...
                    <?php
                      ...
                      $iran=number_format( $coupon->quantity - $coupon->used, 2);
                       

             echo $iran2=substr($iran, 0, -3) ;
             ...
             ?>
                    ...
                    <?php else: ?>
                    <td class="text-center"><div class="badge badge-danger"><?php echo e($coupon->quantity - $coupon->used); ?>
                ...
                <?php echo Form::open(['route' => 'coupons.store', 'method' => 'post']); ?>
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-6 form-group">
                          ...
                          <input type="text" name="expired_date" id="input1" class="form-control form-control-sm">
                      </div>
                  </div>
          ...
          <div class="modal-body">
            <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
              ...
              <div class="row">
                ...
                <div class="col-md-6 form-group">
                    <label><?php echo e(trans('file.Expired Date')); ?></label>
                    <input type="text" name="expired_date" class="form-control form-control-sm"  id="input1">
                </div>
              </div>
              <div class="form-group">
                  <button type="submit" class="btn btn-primary"><?php echo e(trans('file.submit')); ?></button>
            ...
            },
            {
                ...
                action: function ( e, dt, node, config ) {
                    if(user_verified == '1') {
                        ...
                        if(coupon_id.length && confirm("آیا مطمئن هستید که می خواهید حذف کنید؟")) {
                            $.ajax({
                                type:'POST',
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/edogroup/edosale.edogroup.ir/resources/views/coupon/index.blade.php ENDPATH**/ ?>