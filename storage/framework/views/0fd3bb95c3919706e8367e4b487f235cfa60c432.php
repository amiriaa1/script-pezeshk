		...
		$j_date_string = gregorian_to_jalali($gy, $gm, $gd, '/'); //خروجی رشته
                   ...
                   echo $j_date_string;
                    ...
                    ?> 
                        ...
                        <?php echo e(' '. $adjustment->created_at->toTimeString()); ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/edomeir/public_html/edosale_new/resources/views/adjustment/index.blade.php ENDPATH**/ ?>