                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <?php
                                                          $iran=(number_format((float)$product_purchase->net_unit_cost, 2, '.', '') );
                                                        ...
                                                        <td class="discount">
                                                           ...
                                                           <?php
                                                          $iran=( number_format((float)$product_purchase->discount, 2, '.', ''));
                                                           echo     substr($iran, 0, -3).' '.config('currency')  ;
                                                        ?>
                                                        ...
                                                        <td class="tax">
                                                          <?php
                                                          $iran=(number_format((float)$product_purchase->tax, 2, '.', ''));
                                                           echo     substr($iran, 0, -3) .' '.config('currency')  ;
                                                        ?>
                                                        ...
                                                        <td class="sub-total">
                                                             ...
                                                             <?php
                                                          $iran=(number_format((float)$product_purchase->total, 2, '.', ''));
                                                           echo     substr($iran, 0, -3)  .' '.config('currency')  ;
                                                        ?>
                                                        </td>
                                                ...
                                                <tfoot class="tfoot active">
                                                    ...
                                                    <th id="total-discount">
                                                           <?php
                                                          $iran=(number_format((float)$lims_purchase_data->total_discount, 2, '.', ''));
                                                           echo     substr($iran, 0, -3) .' '.config('currency')  ; ;
                                                        ?>
                                                    ...
                                                    <th id="total-tax">
                                                          ...
                                                          <?php
                                                          $iran=( number_format((float)$lims_purchase_data->total_tax, 2, '.', ''));
                                                           echo     substr($iran, 0, -3) .' '.config('currency')  ; ;
                                                        ?>
                                                    ...
                                                    <th id="total">
                                                        ...
                                                        <?php
                                                          $iran=( number_format((float)$lims_purchase_data->total_cost, 2, '.', ''));
                                                           echo     substr($iran, 0, -3).' '.config('currency')  ;  ;
                                                        ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/edogroup/edosale.edogroup.ir/resources/views/purchase/edit.blade.php ENDPATH**/ ?>