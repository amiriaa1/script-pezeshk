  ...
  return ($mod == '')? array($jy, $jm, $jd) : $jy.$mod.$jm.$mod.$jd;
                ...
                <tr data-id="<?php echo e($cash_register->id); ?>">
                    ...
                    <td>
                              ...
                              <?php
       $iran=date($general_setting->date_format . "", strtotime($cash_register->created_at));                
       date_default_timezone_set('Asia/Tehran');
	   list($gy, $gm, $gd) = explode('-',  date('Y-n-d'));
	   $j_date_string = gregorian_to_jalali($gy, $gm, $gd, '/'); 
	   $iran2 = explode("/", $j_date_string);
       $g_y = $iran2[0];
       $g_m=$iran2[1];
       $g_d=$iran2[2];
       echo $g_y. '-' .$g_m. '-'.$g_d ;
       ?>
        ...
        <td>
         <?php
       $iran=date($general_setting->date_format . "", strtotime($cash_register->updated_at));                
       date_default_timezone_set('Asia/Tehran');
	   list($gy, $gm, $gd) = explode('-',  date('Y-n-d'));
	   $j_date_string = gregorian_to_jalali($gy, $gm, $gd, '/');
	   $iran2 = explode("/", $j_date_string);
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/edogroup/edosale.edogroup.ir/resources/views/cash_register/index.blade.php ENDPATH**/ ?>