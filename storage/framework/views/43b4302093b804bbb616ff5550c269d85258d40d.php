                                ...
                                <div id="unit" class="col-md-12">
                                    <div class="row ">
                                        <div class="col-md-4">
                                                ...
                                                <div class="input-group">
                                                  <select required class="form-control selectpicker" data-live-search="true" data-live-search-style="begins" title="انتخاب واحد..." name="unit_id">
                                    ...
                                    <div class="row">
                                        ...
                                        <div id="start_date" class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="starting_date" value="<?php echo e($lims_product_data->starting_date); ?>" id="input1" class="form-control form-control-sm" />
                                            </div>
                                        </div>
                                        <div id="last_date" class="col-md-4">
                                            <div class="form-group">
                                                <label><?php echo e(trans('file.Promotion Ends')); ?></label>
                                                <input type="text" name="last_date" value="<?php echo e($lims_product_data->last_date); ?>" id="input1" class="form-control form-control-sm" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/edogroup/edosale.edogroup.ir/resources/views/product/edit.blade.php ENDPATH**/ ?>