...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo asset('public/vendor/datatable/dataTables.bootstrap4.min.css') ?>">
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo asset('public/vendor/responsive/fixedHeader.bootstrap.min.css') ?>">
        <link rel="stylesheet" type="text/css" href="<?php echo asset('public/vendor/responsive/responsive.bootstrap.min.css') ?>">
    ...
    <script type="text/javascript" src="<?php echo asset('public/vendor/datatable/dataTables.checkboxes.min.js') ?>"></script>
       ...
       <script type="text/javascript" src="<?php echo asset('public/vendor/responsive/dataTables.fixedHeader.min.js') ?>"></script>
       <script type="text/javascript" src="<?php echo asset('public/vendor/responsive/dataTables.responsive.min.js') ?>"></script>
       <script type="text/javascript" src="<?php echo asset('public/vendor/responsive/responsive.bootstrap.min.js') ?>"></script>
...
</html><?php /**PATH /home/edomeir/public_html/edosale_new/resources/views/layout/top-head.blade.php ENDPATH**/ ?>