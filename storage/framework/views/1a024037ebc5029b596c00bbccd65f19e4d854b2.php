                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                               <label><strong>اندازه کاغذ*  </strong></label>
                                        <select class="form-control" name="paper_size" required id="paper-size">
                                 <option value="0">انتخاب اندازه کاغذ...</option>
<option value="36">36 میلی متر (1.4 اینج)</option>
<option value="24">24 میلی متر (0.94 اینج)</option>
<option value="18">18 میلی متر (0.7 اینج)</option>
...
<script type="text/javascript">
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if(flag){
                    ...
                    cols += '<td><button type="button" class="ibtnDel btn btn-md btn-danger">حذف</button></td>';
    ...
    $("#submit-button").on("click", function(event) {
        ...
        if(paper_size != "0") {
                ...
                while(i < qty[index]) {
                    ...
                    if($('input[name="promo_price"]').is(":checked")) {
                        if(currency_position[index] == 'prefix')
                            htmltext += 'قیمت: '+currency[index]+'<span style="text-decoration: line-through;"> '+price[index]+'</span> '+promo_price[index]+'<br>';
                        else
                            htmltext += 'قیمت: <span style="text-decoration: line-through;">'+price[index]+'</span> '+promo_price[index]+' '+currency[index]+'<br>';
                    }
                    else if($('input[name="price"]').is(":checked")) {
                        if(currency_position[index] == 'prefix')
                            htmltext += 'قیمت: '+currency[index]+' '+price[index];
                        else
                            htmltext += 'قیمت: '+price[index]+' '+currency[index];
                    }
                    htmltext +='</td>';
                    if(i % 2 != 0)
                        htmltext +='</tr>';
            ...
            alert('لطفاً اندازه کاغذ را انتخاب کنید');
    });
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/edomeir/public_html/edosale_new/resources/views/product/print_barcode.blade.php ENDPATH**/ ?>