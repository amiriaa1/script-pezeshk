        ...
        <table id="gift_card-table" class="table">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(trans('مبلغ')); ?></th>
                    <th><?php echo e(trans('هزینه')); ?></th>
                    <th><?php echo e(trans('باقی مانده')); ?></th>
            ...
            <tbody>
                ...
                <tr data-id="<?php echo e($gift_card->id); ?>">
                    ...
                    <td>
                      ...
                      $iran=number_format($gift_card->amount , 2);
          ...
          echo   $iran2=substr($iran, 0, -3)  .' '.config('currency');
                    ...
                    <td>
                      ...
                      $iran=number_format($gift_card->expense , 2);
          ...
          echo   $iran2=substr($iran, 0, -3)  .' '.config('currency');
                    ...
                    <?php
                      ...
                      $iran=number_format($gift_card->amount - $gift_card->expense, 2);
          ...
          <div class="modal-body">
              <div class="gift-card" style="margin: 0 auto; max-width: 350px; position: relative; color:#fff;"><img src="<?php echo e(url('public/images/gift_card/front.jpg')); ?>" width="350" height="200">
                <div style="position: absolute; padding: 15px; top:0; left: 0; width: 350px;">
                    <h3 class="d-inline">کارت هدیه</h3><h3 class="d-inline float-right"><?php echo e($general_setting->currency); ?> <span id="balance"></span></h3>
                    ...
                    <span class="valid" style="font-size: 11px;">معتبر از طریق</span>
              ...
              <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                ...
                ?>
                  ...
                  <div class="form-group customer_list">
                      ...
                      <select name="customer_id" class="selectpicker form-control" required data-live-search="true" data-live-search-style="begins" title="انتخاب مشتری...">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" name="expired_date" class="form-control" id="input1" class="form-control form-control-sm">
                  </div>
                  <div class="form-group">
            ...
            <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
              ...
              ?>
                ...
                <div class="form-group user_list_edit">
                    <label><?php echo e(trans('file.User')); ?> *</label>
                    <select name="user_id_edit" class="selectpicker form-control" required data-live-search="true" data-live-search-style="begins" title="انتخاب کاربر...">
                        <?php $__currentLoopData = $lims_user_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($user->id); ?>"><?php echo e($user->name .' ('.$user->email.')'); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                ...
                <div class="form-group customer_list_edit">
                    <label><?php echo e(trans('file.customer')); ?> *</label>
                    <select name="customer_id_edit" class="selectpicker form-control" required data-live-search="true" data-live-search-style="begins" title="انتخاب مشتری...">
                        <?php $__currentLoopData = $lims_customer_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($customer->id); ?>"><?php echo e($customer->name .' ('.$customer->phone_number.')'); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                ...
                <div class="form-group">
                    <label><?php echo e(trans('file.Expired Date')); ?></label>
                    <input type="text" name="expired_date_edit" id="input1" class="form-control form-control-sm">
                </div>
                <div class="form-group">
                    <button type="submit" class="btn btn-primary"><?php echo e(trans('file.submit')); ?></button>
                </div>
  ...
  <div role="document" class="modal-dialog">
      <div class="modal-content">
          <div class="modal-header">
              ...
              <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
               <h5 id="exampleModalLabel" class="modal-title" style="color: #f18a3c;    font-weight: 100;"> <?php echo e(trans('file.Card No')); ?>: <span id="card-no"></span></h5>
          </div>
          <div class="modal-body">
            <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/edogroup/edosale.edogroup.ir/resources/views/gift_card/index.blade.php ENDPATH**/ ?>