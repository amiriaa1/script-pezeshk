              ...
              <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <select class="form-control selectpicker" name="employee_id[]" required data-live-search="true" data-live-search-style="begins" title="انتخاب کارمند..." multiple>
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="date" class="form-control form-control-sm" id="input1"    required>
                    </div>
                    <div class="col-md-6 form-group">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/edogroup/edosale.edogroup.ir/resources/views/attendance/index.blade.php ENDPATH**/ ?>