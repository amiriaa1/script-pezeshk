                        ...
                        <?php echo Form::open(['route' => 'setting.posStore', 'method' => 'post']); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label>رمز عبور درگاه پرداخت</label>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/edogroup/edosale.edogroup.ir/resources/views/setting/pos_setting.blade.php ENDPATH**/ ?>