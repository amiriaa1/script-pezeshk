...
<section>
            ...
            <div class="card-body">
				<div class="col-md-12">
					<div class="col-md-6 offset-md-3 mt-3 text-center">
						...
						<p style="    font-family: 'Shabnam';">برای مشاهده نمودار ، انبار را انتخاب کنید</p>
					...
					<div class="col-md-6 offset-md-3 mt-3 mb-3">
						<div class="row">
							<div class="col-md-6">
								<span style="    font-family: 'Shabnam';">مجموع <?php echo e(trans('file.Items')); ?></span>
								<h2><strong>
    ...
    $iran=number_format((float)$total_item, 2, '.', '');
     ...
     echo     substr($iran, 0, -3)  ;
							...
							<div class="col-md-6">
								<span style="    font-family: 'Shabnam';">مجموع <?php echo e(trans('file.Quantity')); ?></span>
								<h2><strong>
								<?php
								
								
    $iran=number_format((float)$total_qty, 2, '.', '');
     ...
     echo     substr($iran, 0, -3)  ;
					...
					<div class="col-md-5 offset-md-3 mt-2" style="    font-family: 'Shabnam';">
						<div class="pie-chart" style="    font-family: 'Shabnam';" >
							<?php
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/edogroup/edosale.edogroup.ir/resources/views/report/warehouse_stock.blade.php ENDPATH**/ ?>