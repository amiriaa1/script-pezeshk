                ...
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control selectpicker" id="base_unit_create" name="base_unit">
                            <option value="">عدم پایه واحد</option>
                    ...
                    <div class="form-group operator">
                        <label><?php echo e(trans('file.Operator')); ?></label> <input type="text" name="operator"  style="font-family: 'Shabnam';" placeholder="نام را وارد کنید" class="form-control" />
                    </div>
                    <div class="form-group operation_value">
                        <label><?php echo e(trans('file.Operation Value')); ?></label><input type="number" style="font-family: 'Shabnam';" name="operation_value" placeholder="مقدار عملکرد را وارد کنید" class="form-control" step="any"/>
                    </div>
            ...
            <form>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control selectpicker" id="base_unit_edit" name="base_unit">
                        <option value="">عدم پایاه واحد</option>
                        <?php $__currentLoopData = $lims_unit_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($unit->base_unit==null): ?>
                            <option value="<?php echo e($unit->id); ?>"><?php echo e($unit->unit_name); ?></option>
                            <?php endif; ?>
                ...
                <div class="form-group operator">
                    <label><?php echo e(trans('file.Operator')); ?></label> <input type="text" name="operator" placeholder="نام را وارد کنید" class="form-control" />
                </div>
                <div class="form-group operation_value">
                    <label><?php echo e(trans('file.Operation Value')); ?></label><input type="number" name="operation_value" placeholder="مقدار عملکرد را وارد کنید" class="form-control" step="any"/>
                </div>
                <input type="submit" value="<?php echo e(trans('file.submit')); ?>" class="btn btn-primary">
            </form>
        </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/edogroup/edosale.edogroup.ir/resources/views/unit/create.blade.php ENDPATH**/ ?>