...
<html>
  <head>
    ...
    <style type="text/css">
     ...
     @font-face {
    font-family: 'Shabnam';
    src: url(/public/css/fonts/Shabnam.eot);
    src: url(/public/css/fonts/Shabnam.eot?#iefix) format("embedded-opentype"),
    url(/public/css/fonts/Shabnam.woff) format("woff"),
    url(/public/css/fonts/Shabnam.ttf) format("truetype");
    font-weight: normal;
    font-style: normal;
          }
...
180deg,#aae181,#89d351);
    box-shadow: 0 2px 15px rgb(137 211 81 / 43%);
    -webkit-box-shadow: rgb(137 211 81 / 43%) 0 2px 15px;
        }
        td,
        th,
        tr,
...
<div style="max-width:400px;margin:0 auto">
    ...
    <div id="receipt-data">
        <div class="centered">
            ...
            <h2 style="color: #8ed557;"><?php echo e($lims_biller_data->company_name); ?></h2>
        ...
        <table>
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:left;vertical-align:bottom;direction: rtl;" >
                        
                        
                        <?php
                         $iran=number_format((float)$product_sale_data->total, 2, '.', '');
            ...
            <tfoot>
                <tr>
                    <th colspan="2" style="color: #8ed557;"><?php echo e(trans('file.Total')); ?></th>
                    <th style="text-align:left;direction: rtl;color: #8ed557;" >
                        
                          <?php
                         $iran=number_format((float)$lims_sale_data->total_price, 2, '.', '');
                       echo     substr($iran, 0, -3).' '.config('currency'); ;
                ...
                <tr>
                    ...
                    <td style="text-align:left;direction: rtl;">
                                ...
                                <?php
    $iran=number_format((float)$total_product_tax, 2, '.', '');
     echo     substr($iran, 0, -3);
                ...
                <tr>
                    ...
                    <td style="text-align:left;direction: rtl;">
                                  ...
                                  <?php
    $iran=number_format((float)($total_product_tax / 2), 2, '.', '');
     echo     substr($iran, 0, -3);
                        ?>
    ...
    $iran=number_format((float)($total_product_tax / 2), 2, '.', '');
     echo     substr($iran, 0, -3);
                ...
                <tr>
                    ...
                    <th style="text-align:left;direction: rtl;">
                        
                        
                        
                                <?php
    $iran=number_format((float)$lims_sale_data->order_tax, 2, '.', '');
     echo     substr($iran, 0, -3);
                        ?>
                ...
                <tr>
                    ...
                    <th style="text-align:left;direction: rtl;">
                               ...
                               <?php
    $iran=number_format((float)$lims_sale_data->order_discount, 2, '.', '');
     echo     substr($iran, 0, -3);
                        ?>
                ...
                <tr>
                    ...
                    <th style="text-align:left;direction: rtl;">
                              ...
                              <?php
    $iran=number_format((float)$lims_sale_data->coupon_discount, 2, '.', '');
     echo     substr($iran, 0, -3);
                        ?>
                ...
                <tr>
                    ...
                    <th style="text-align:left;direction: rtl;">
                        <?php
    $iran=number_format((float)$lims_sale_data->shipping_cost, 2, '.', '');
     echo     substr($iran, 0, -3);
                        ?>
                ...
                <tr>
                    ...
                    <th style="text-align:left;direction: rtl;">
                              ...
                              <?php
    $iran=number_format((float)$lims_sale_data->grand_total, 2, '.', '');
     echo     substr($iran, 0, -3);
                        ?>
 ...
 if ($payment_data->paying_method == "Gift Card") {
                                echo "کارت هدیه";
 

                                 }
                                  if ($payment_data->paying_method== "Credit Card") {
                                echo "کارت اعتباری";
                                ...
                                echo "سپرده ";
                                     ...
                                     if ($payment_data->paying_method== "Paypal") {
                                echo " پرداخت";
    ...
    $iran=number_format((float)$payment_data->amount, 2, '.', '');
                                                
   $iran2=substr($iran, 0, -3) ;


                    ?>
                    <td style="padding: 5px;width:40%"><?php echo e(trans('file.Amount')); ?>: <?php   echo $iran2 .' '.config('currency'); ?></td>
                    
                              <?php
                    
    $iran=number_format((float)$payment_data->change, 2, '.', '');
                                                
   $iran3=substr($iran, 0, -3) ;
                    ...
                    <td style="padding: 5px;width:30%"><?php echo e(trans('تغییر')); ?>: <?php   echo $iran3 .' '.config('currency'); ?> </td>
                </tr>                
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <tr><td class="centered" colspan="3" style="    color: #97b5d4;"><?php echo e(trans('file.Thank you for shopping with us. Please come again')); ?></td></tr>
                <tr>
...
<?php /**PATH /home/edogroup/edosale.edogroup.ir/resources/views/sale/invoice.blade.php ENDPATH**/ ?>