                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" id="name" aria-describedby="name" required title="این قسمت الزامی است">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="code" class="form-control" id="code" aria-describedby="code" required title="این قسمت الزامی است">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <select name="barcode_symbology" required class="form-control selectpicker">
                                                <option value="C128">کد 128</option>
                                                <option value="C39">کد 39</option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                          <select name="brand_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="انتخاب برند ...">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                          <select name="category_id" required class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="انتخاب دسته بندی ...">
                                ...
                                <div id="unit" class="col-md-12">
                                    <div class="row ">
                                        <div class="col-md-4 form-group">
                                                ...
                                                <div class="input-group">
                                                  <select required class="form-control selectpicker" name="unit_id"  title="این قسمت الزامی است">
                                                   <option value="" disabled selected>انتخاب واحد محصول ... </option>
                                        ...
                                        <div class="col-md-4">
                                                ...
                                                <div class="input-group">
                                                  <select class="form-control selectpicker" name="sale_unit_id"  title="عدم انتخاب"> 
                                                  </select>
                                              </div>
                                        </div>
                                        <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                      <select class="form-control selectpicker" name="purchase_unit_id" title="عدم انتخاب"> 
                                                      </select>
                                                  </div>
                                                </div>
                                        </div>                                
                                ...
                                <div id="cost" class="col-md-4">
                                     <div class="form-group">
                                        ...
                                        <input type="number" name="cost" required class="form-control" step="any"  title="این قسمت الزامی است">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="price" required class="form-control" step="any"  title="این قسمت الزامی است">
                                        <span class="validation-msg"></span>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div id="alert-qty" class="col-md-4">
								  ...
								  <div id="site" class="col-md-4">
                                    <div class="form-group">
                                        <label>site</strong> </label>
                                        <input type="text" name="site" class="form-control" step="any">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="tax_id" class="form-control selectpicker">
                                            <option value="">عدم مالیات </option>
                                        ...
                                        <div class="col-md-4" id="start_date">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="starting_date"  id="input1" class="form-control form-control-sm" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4" id="last_date">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="last_date" id="input1" class="form-control form-control-sm" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>  
    ...
    jQuery.validator.setDefaults({
        errorPlacement: function (error, element) {
            if(error.html() == 'Select Category...')
                error.html('این قسمت الزامی است');
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\script\resources\views/product/create.blade.php ENDPATH**/ ?>