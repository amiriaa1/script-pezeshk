                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                    <button type="submit" class="btn btn-link" onclick="return confirm('آیا مطمئن هستید که می خواهید حذف کنید؟')"><i class="dripicons-trash"></i> <?php echo e(trans('file.delete')); ?></button>
                                </li>
        ...
        <div class="modal-body">
          <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
            <div class="form-group">
                ...
                <?php echo e(Form::text('title',null,array('required' => 'required', 'class' => 'form-control', 'placeholder' => 'عنوان برند را وارد کنید....'))); ?>
    ...
    $("#export").on("click", function(e){
        ...
        $.ajax({
           ...
           success:function(data){
            alert('با موفقیت به پرونده اکسل صادر شد! برای بارگیری پرونده روی تأیید کلیک کنید');
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/edogroup/edosale.edogroup.ir/resources/views/brand/create.blade.php ENDPATH**/ ?>