...
<section>
    ...
    $iran=(number_format($customer->deposit - $customer->expense, 2));
            ...
            },
            {
                ...
                action: function ( e, dt, node, config ) {
                    if(user_verified == '1') {
                        ...
                        if(customer_id.length && confirm("آیا مطمئن هستید که می خواهید حذف کنید؟")) {
                            $.ajax({
                                type:'POST',
                            ...
                            alert('هیچ مشتری انتخاب نشده است!');
                    }
                    else
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/edogroup/edosale.edogroup.ir/resources/views/customer/index.blade.php ENDPATH**/ ?>