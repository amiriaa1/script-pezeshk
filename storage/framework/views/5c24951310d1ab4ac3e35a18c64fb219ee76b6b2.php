              ...
              <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <select class="form-control selectpicker" name="employee_id" required data-live-search="true" data-live-search-style="begins" title=" انتخاب کارمند...">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <select class="form-control selectpicker" name="paying_method" required>
                            ...
                            <option value="2"> کارت اعتباری</option>
                        </select>
                    </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/edogroup/edosale.edogroup.ir/resources/views/payroll/index.blade.php ENDPATH**/ ?>