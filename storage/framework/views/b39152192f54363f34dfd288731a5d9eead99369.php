        ...
        <table id="user-table" class="table">
            ...
            <tbody>
                ...
                <tr data-id="<?php echo e($user->id); ?>">
                    ...
                    <td><div class="badge badge-success">فعال</div></td>
                    <?php else: ?>
                    <td><div class="badge badge-danger">غیرفعال</div></td>
                    <?php endif; ?>
                    <td>
                        <div class="btn-group">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/edogroup/edosale.edogroup.ir/resources/views/user/index.blade.php ENDPATH**/ ?>