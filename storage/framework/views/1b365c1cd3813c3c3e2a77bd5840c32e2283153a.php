        ...
        <table id="stock-count-table" class="table stock-count-list">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(trans('لیست انبارها')); ?></th>
...
?>
       ...
       $iran= $stock_count->created_at->toDateString();
		...
		$j_date_string = gregorian_to_jalali($gy, $gm, $gd, '/'); //خروجی رشته
                   ...
                   echo $j_date_string;
                    ...
                    ?> 
                        ...
                        <?php echo e(' '. $stock_count->created_at->toTimeString()); ?></td>
          ...
          <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
            <div class="row">
                ...
                <div class="col-md-6 form-group" id="category">
                    ...
                    <select name="category_id[]" id="category_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="انتخاب دسته بندی ..." multiple>
                ...
                <div class="col-md-6 form-group" id="brand">
                    ...
                    <select name="brand_id[]" id="brand_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="انتخاب برند..." multiple>
...
<script type="text/javascript">
    ...
    $("#print-btn").on("click", function(){
          ...
          newWin.document.write('<link rel="stylesheet" href="<?php echo asset('public/vendor/bootstrap/css/bootstrap.min.css') ?>" type="text/css"><style type="text/css">@media  print {.modal-dialog { max-width: 1000px;font-family:"tahoma"} }</style><body onload="window.print()">'+divToPrint.innerHTML+'</body>');
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/edogroup/edosale.edogroup.ir/resources/views/stock_count/index.blade.php ENDPATH**/ ?>