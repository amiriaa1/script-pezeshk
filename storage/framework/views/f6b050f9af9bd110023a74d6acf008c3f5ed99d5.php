                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="lims_customerSearch" id="lims_customerSearch" placeholder="لطفاً نام مشتری یا شماره تلفن همراه را تایپ کرده و ... را انتخاب کنید" />
                                    </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/edomeir/public_html/edosale_new/resources/views/setting/create_sms.blade.php ENDPATH**/ ?>