    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-6 form-group" style="    color: #8ed557;">
                        <label ><?php echo e(trans('file.Delivery Reference')); ?></label>
                        <p id="dr" ></p>
                    </div>
                    <div class="col-md-6 form-group" style="color:#fbcb65">
...
<script type="text/javascript">
    ...
    function deliveryDetails(delivery, barcode) {
        ...
        var newBody = $("<tbody>");
        var rows = '';
        rows += '<tr><td>تاریخ</td><td>'+delivery[0]+'</td></tr>';
        rows += '<tr><td>مرجع تحویل</td><td>'+delivery[1]+'</td></tr>';
        rows += '<tr><td>مرجع فروش</td><td>'+delivery[2]+'</td></tr>';
        rows += '<tr><td>وضیعت ها</td><td>'+delivery[3]+'</td></tr>';
        rows += '<tr><td>نــام مشتری</td><td>'+delivery[5]+'</td></tr>';
        rows += '<tr><td>نشانی</td><td>'+delivery[7]+', '+delivery[8]+'</td></tr>';
        rows += '<tr><td>شماره تماس</td><td>'+delivery[6]+'</td></tr>';
        rows += '<tr><td>یادداشت</td><td>'+delivery[9]+'</td></tr>';
        ...
        var htmlfooter = '<div class="col-md-4 form-group"><p>متصدی: '+delivery[10]+'</p></div>';
        htmlfooter += '<div class="col-md-4 form-group"><p>تحویل دهنده: '+delivery[11]+'</p></div>';
        htmlfooter += '<div class="col-md-4 form-group"><p>تحویل گیرنده: '+delivery[12]+'</p></div>';
            ...
            },
            {
                ...
                action: function ( e, dt, node, config ) {
                    if(user_verified == '1') {
                        ...
                        if(delivery_id.length && confirm("آیا مطمئن هستید که می خواهید حذف کنید؟")) {
                            $.ajax({
                                type:'POST',
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/edogroup/edosale.edogroup.ir/resources/views/delivery/index.blade.php ENDPATH**/ ?>