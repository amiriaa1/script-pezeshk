...
<script type="text/javascript" src="<?php echo asset('public/js/front.js') ?>"></script>
  ...
  <body>
    <div class="page login-page">
      ...
      <div class="container">
        <div class="form-outer text-center d-flex align-items-center" style="    background-color: #f5f5f500;">
          <div class="form-inner" style="    width: calc(100% - 15px);
    background: #fff;
    ...
    font-size: 15px;">
              ...
              <img src="https://teslainvoice.ir/tesla_files/logoLandin.png">
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>" id="login-form">
              ...
              <label for="login-password" class="label-material"  style="    font-size: 11px;">فــروش در سایت راست چین امکان پذیر می باشد       </label>
              <label for="login-password" class="label-material" style="font-size: 11px;">تمامی حقوق برای شرکت ایدو محفوظ است </label>
...
</script><?php /**PATH /home/edomeir/public_html/edosale/resources/views/auth/login.blade.php ENDPATH**/ ?>