    ...
    <div class="side-navbar-wrapper">
      ...
      <div class="main-menu">
        <ul id="side-main-menu" class="side-menu list-unstyled">                  
          ...
          <li class=""><a href="#hrm" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-user-group"></i><span>شرکت ایدو </span></a>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="search-box form-group" style="    font-family: 'Shabnam';">
                                            <input type="text" name="product_code_name" id="lims_productcodeSearch" placeholder="محصول را با نام /  اسکن  / جستجو کنید" class="form-control"  />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="row" style="display: none;">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="total_discount" value="0.0" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="total_tax" value="0.0"/>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                ...
                                <div class="col-12 totals" style="border-top: 2px solid #e4e6fc; padding-top: 10px;font-family: 'Shabnam';">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <span class="totals-title"><?php echo e(trans('file.Items')); ?></span><span id="item">0</span>
                                        </div>
                                        <div class="col-sm-4">
                                            <span class="totals-title"><?php echo e(trans('file.Total')); ?></span><span id="subtotal">0.0</span>
                                        </div>
                                        <div class="col-sm-4">
                                            <span class="totals-title"><?php echo e(trans('file.Discount')); ?> <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#order-discount"> <i class="dripicons-document-edit"></i></button></span><span id="discount">0.0</span>
                                        </div>
                                        <div class="col-sm-4">
                                            <span class="totals-title"><?php echo e(trans('file.Coupon')); ?> <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#coupon-modal"><i class="dripicons-document-edit"></i></button></span><span id="coupon-text">0.0</span>
                                        </div>
                                        <div class="col-sm-4">
                                            <span class="totals-title"><?php echo e(trans('file.Tax')); ?> <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#order-tax"><i class="dripicons-document-edit"></i></button></span><span id="tax">0.0</span>
                                        </div>
                                        <div class="col-sm-4">
                                            <span class="totals-title"><?php echo e(trans('file.Shipping')); ?> <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#shipping-cost-modal"><i class="dripicons-document-edit"></i></button></span><span id="shipping-cost">0.0</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="payment-amount">
                        <h2><?php echo e(trans('file.grand total')); ?> <span id="grand-total">0.0</span></h2>
                    </div>
                    <div class="payment-options">
                  
                    
                        <div class="column-5">
                            <button style="background-color: #213170" type="button" class="btn btn-custom payment-btn" data-toggle="modal" data-target="#add-payment" id="paypal-btn"><i class="fa fa-paypal"></i> <span style="    font-family: 'Shabnam';" >پرداخت</span></button>
                        </div>
                    
                 
                        <div class="column-5">
                            <button style="background-color: #d63031;" type="button" class="btn btn-custom" id="cancel-btn" onclick="return confirmCancel()"><i class="fa fa-close"></i><span style="    font-family: 'Shabnam';" >انصراف</span> </button>
                        </div>
                        <div class="column-5">
                            <button style="background-color: #ffc107;" type="button" class="btn btn-custom" data-toggle="modal" data-target="#recentTransaction"><i class="dripicons-clock"></i><span style="    font-family: 'Shabnam';" >انتقالات اخیر</span>  </button>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-md-10">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mt-1">
                                            ...
                                            <p id="change" class="ml-2">0.0</p>
                                        </div>
                                        <div class="col-md-6 mt-1">
                                            <input type="hidden" name="paid_by_id" required>
                                            <label><?php echo e(trans('file.Paid By')); ?></label>
                                            <select name="paid_by_id_select" class="form-control selectpicker" required>
                                                <option value="1">نقدی</option>
                                                <option value="2">کارت هدیه</option>
                                                <option value="3">کارت اعتباری</option>
                                                <option value="4">چک</option>
                                                <option value="5">پرداخت</option>
                                                <option value="6">سپرده</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group col-md-12 gift-card">
                                            ...
                                            <select id="gift_card_id_select" name="gift_card_id_select" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="کارت هدیه را انتخاب کنید ..."></select>
                                        </div>
                                        <div class="form-group col-md-12 cheque" required>
                                        ...
                                        <div class="form-group col-md-12" required>
                                            ...
                                            <textarea id="payment_note" rows="2" class="form-control" name="payment_note" required ></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                       <div class="col-md-6 form-group" required>
                                            <label><?php echo e(trans('file.Sale Note')); ?></label>
                                            <textarea rows="3" class="form-control" name="sale_note" required></textarea>
                                        </div>
                                        <div class="col-md-6 form-group">
                                            <label><?php echo e(trans('file.Staff Note')); ?></label>
                                            <textarea rows="3" class="form-control" name="staff_note" required></textarea>
                                        </div>
                                    </div>
                                    <div class="mt-3">
            ...
            <div id="coupon-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <input type="text" id="coupon-code" class="form-control" placeholder="کد کوپن را تایپ کنید ...">
                            </div>
            ...
            <div class="col-md-6">
                ...
                <header class="header">
                    <nav class="navbar">
                      <div class="container-fluid" style="background: #304967;">
                        <div class="navbar-holder d-flex align-items-center justify-content-between">
                          ...
                          <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                            ...
                            <li class="nav-item" id="notification-icon">
                                  ...
                                  <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default notifications" user="menu">
                                      <li class="notifications">
                                        <a href="<?php echo e(route('report.qtyAlert')); ?>" class="btn btn-link"><?php echo e($alert_product); ?> محصول از مقدار هشدار فراتر رفته است</a>
                                      </li>
                            ...
                            <li class="nav-item">
                                  <a rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-item" style="color: #ffc151;"><i class="dripicons-user"></i> <span><?php echo e(ucfirst(Auth::user()->name)); ?></span> <i class="fa fa-angle-down"></i>
                                  </a>
                                  <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                      <li> 
                                        <a href="<?php echo e(route('user.profile', ['id' => Auth::id()])); ?>"><i class="dripicons-user" style="color: #ffc107;"> </i> <?php echo e(trans('file.profile')); ?></a>
                                      </li>
                                      <?php if($general_setting_permission_active): ?>
                                      <li> 
                                        <a href="<?php echo e(route('setting.general')); ?>"><i class="dripicons-gear" style="color: #ffc107;"></i> <?php echo e(trans('file.settings')); ?></a>
                                      </li>
                                      <?php endif; ?>
                                      <li> 
                                        <a href="<?php echo e(url('my-transactions/'.date('Y').'/'.date('m'))); ?>"><i class="dripicons-swap" style="color: #ffc107;"></i> <?php echo e(trans('file.My Transaction')); ?></a>
                                      </li>
                                      <li> 
                                        <a href="<?php echo e(url('holidays/my-holiday/'.date('Y').'/'.date('m'))); ?>"><i class="dripicons-vibrate" style="color: #ffc107;"></i> <?php echo e(trans('file.My Holiday')); ?></a>
                                      </li>
                                      <li>
                                        <a href="<?php echo e(route('logout')); ?>"
                                           onclick="event.preventDefault();
                                                         document.getElementById('logout-form').submit();"><i class="dripicons-power" style="color: #ffc107;"></i>
                ...
                <div class="filter-window">
                    <div class="category mt-3">
                        <div class="row ml-2 mr-2 px-2">
                            <div class="col-7" style="font-family: 'Shabnam';">انتخاب دسته بندی</div>
                    ...
                    <div class="brand mt-3">
                        <div class="row ml-2 mr-2 px-2">
                            <div class="col-7" style="font-family: 'Shabnam';">انتخاب برند</div>
                            <div class="col-5 text-right">
                                <span class="btn btn-default btn-sm">
                                    <i class="dripicons-cross"></i>
                                </span>
                    ...
                    <div class="modal-body">
                      <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="email" placeholder="info@edogroup.ir" class="form-control">
                        </div>
                        <div class="form-group">
...
function populateProduct(data) {
    ...
    if (Object.keys(data).length != 0) {
        ...
        tableData += '<td class="text-center">هیچ داده ای قابل دسترسی نیست</td></tr></tbody></table>'
        $(".table-container").html(tableData);
    }
}
...
$(document).on('click', '.product-img', function() {
    ...
    if(!customer_id)
        ...
        if(pos < 0)
            alert('محصول در انبار انتخاب شده قابل دسترسی نیست');
        else{
...
$("#draft-btn").on("click",function(){
    ...
    if (rownumber < 0) {
        alert("لطفا محصول را برای سفارش جدول وارد کنید!")
    }
    else
        $('.payment-form').submit();
});
...
$('#add-payment select[name="gift_card_id_select"]').on("change", function() {
    ...
    if($('input[name="paid_amount"]').val() > balance){
        alert('مبلغ بیش از مانده کارت است! موجودی کارت هدیه: '+ balance);
    }
});
...
$('input[name="paid_amount"]').on("input", function() {
    if( $(this).val() > parseFloat($('input[name="paying_amount"]').val()) ) {
        alert('مبلغ پرداخت نمی تواند بزرگتر از مبلغ دریافتی باشد');
        $(this).val('');
    }
    else if( $(this).val() > parseFloat($('#grand-total').text()) ){
        alert('مبلغ پرداختی نمی تواند بزرگتر از مبلغ کل باشد');
        $(this).val('');
    }
    ...
    if(id == 2){
        ...
        if( $('input[name="paid_amount"]').val() > deposit[$('#customer_id').val()] )
            alert('مبلغ بیش از سپرده مشتری است! سپرده مشتری : '+ deposit[$('#customer_id').val()]);
    }
});
...
$(document).on('click', '.qc-btn', function(e) {
    if($(this).data('amount')) {
        ...
        $('input[name="paying_amount"]').val('0.0');
...
function addNewProduct(data){
    ...
    cols += '<td class="col-sm-4 product-title"><button type="button" class="edit-product btn btn-link" data-toggle="modal" data-target="#editModal"><strong>' + data[0] + '</strong></button> [' + data[1] + '] <p>موجودی انبار: <span class="in-stock"></span></p></td>';
...
function couponDiscount() {
    var rownumber = $('table.order-list tbody tr:last').index();
    if (rownumber < 0) {
        alert("لطفا برای سفارش جدول محصول را وارد کنید!")
    }
...
$(document).on('submit', '.payment-form', function(e) {
    ...
    if (rownumber < 0) {
        ...
        alert('مبلغ پرداختی نمی تواند بیشتر از مبلغ دریافتی باشد');
        e.preventDefault();
    }
...
<?php echo $__env->make('layout.top-head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/edogroup/edosale.edogroup.ir/resources/views/sale/pos.blade.php ENDPATH**/ ?>