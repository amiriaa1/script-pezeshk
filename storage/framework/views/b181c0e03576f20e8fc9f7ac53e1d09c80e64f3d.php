...
<section>
    ...
    <div class="table-responsive">
       ...
       $iran= $money_transfer->created_at->toDateString();
       date_default_timezone_set('Asia/Tehran');
       list($gy, $gm, $gd) = explode('-', ($iran));
		...
		$j_date_string = gregorian_to_jalali($gy, $gm, $gd, '/'); //خروجی رشته
                   ...
                   echo $j_date_string;
                    ...
                    ?> 
                           <?php echo e($money_transfer->created_at->toTimeString()); ?>
  ...
  $iran=number_format($money_transfer->amount, 2);
                ...
                <?php echo Form::open(['route' => 'money-transfers.store', 'method' => 'post']); ?>
                  ...
                  <div class="row">
                      <div class="col-md-6 form-group">
                          ...
                          <select class="form-control selectpicker" name="from_account_id" data-live-search="true" data-live-search-style="begins" title="انتخاب از حساب ..." required>
                      ...
                      <div class="col-md-6 form-group">
                          ...
                          <select class="form-control selectpicker" name="to_account_id" data-live-search="true" data-live-search-style="begins" title="برای حساب انتخاب کنید ..." required>
                          <?php $__currentLoopData = $lims_account_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($account->id); ?>"><?php echo e($account->name); ?> [<?php echo e($account->account_no); ?>]</option>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          </select>
            ...
            },
            {
                ...
                action: function ( e, dt, node, config ) {
                    if(user_verified == '1') {
                        ...
                        if(money_transfer_id.length && confirm("آیا مطمئن هستید که می خواهید حذف کنید؟")) {
                            $.ajax({
                                type:'POST',
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/edomeir/public_html/edosale_new/resources/views/money_transfer/index.blade.php ENDPATH**/ ?>