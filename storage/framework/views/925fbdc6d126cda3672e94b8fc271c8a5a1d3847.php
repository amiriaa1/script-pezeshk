              ...
              <div class="row">
                ...
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center" style="background: linear-gradient(0deg,#82c94a,#9fe16b) ;    padding: 0px 1px;">
                    ...
                    <div class="name"><strong style="color: #fff;font-size: 12px;"><?php echo e(trans('مجموع کل فروش ها')); ?></strong></div>
                ...
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center" style="    background: linear-gradient(0deg,#ffb341,#ffcc5e);    padding: 0px 1px;">
                    ...
                    <div class="name"><strong style="color: #fff;font-size: 12px;"><?php echo e(trans('file.Sale Return')); ?></strong></div>
                ...
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center"style="background:linear-gradient(30deg, #DB9439 0%, #FE5B84 58%);   padding: 0px 1px;">
                    ...
                    <div class="name"><strong style="color: #fff;font-size: 12px;"><?php echo e(trans('file.Purchase Return')); ?></strong></div>
                ...
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center" style="background-color: #17a2b8;  padding: 0px 1px;">
                    ...
                    <div class="name"><strong style="color: #fff;font-size: 12px;"><?php echo e(trans('file.profit')); ?></strong></div>
              ...
              <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center" >
                  ...
                  <div class="right-column">
                    <div class="badge badge-primary">5 <?php echo e(trans('file.latest')); ?> </div>
                  </div>
                </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/edogroup/edosale.edogroup.ir/resources/views/index.blade.php ENDPATH**/ ?>