            ...
            <div class="modal-body">
                <?php echo Form::open(['route' => 'sale.add-payment', 'method' => 'post', 'files' => true, 'class' => 'payment-form' ]); ?>
                    ...
                    <div class="gift-card form-group">
                        ...
                        <select id="gift_card_id" name="gift_card_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="انتخاب کارت اعتباری....">
                            <?php 
                                $balance = [];
                                $expired_date = [];
                            ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo Form::open(['route' => 'sale.update-payment', 'method' => 'post', 'class' => 'payment-form' ]); ?>
                    ...
                    <div class="gift-card form-group">
                        <label> <?php echo e(trans('file.Gift Card')); ?> *</label>
                        <select id="gift_card_id" name="gift_card_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="کارت هدیه را انتخاب کنید ...">
                            <?php $__currentLoopData = $lims_gift_card_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gift_card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($gift_card->id); ?>"><?php echo e($gift_card->card_no); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
<script type="text/javascript">
    ...
    $('input[name="amount"]').on("input", function() {
        ...
        if(id == 2){
            ...
            if(amount > parseFloat(deposit))
                alert('مبلغ بیش از سپرده مشتری است! سپرده مشتری: ' + deposit);
        }
    });
    ...
    $('#edit-payment select[name="gift_card_id"]').on("change", function() {
        ...
        if(expired_date[id] < current_date)
            ...
            alert('مبلغ بیش از مانده کارت است! موجودی کارت هدیه: '+ balance[id]);
    });
            ...
            },
            {
                ...
                action: function ( e, dt, node, config ) {
                    if(user_verified == '1') {
                        ...
                        if(sale_id.length && confirm("آیا مطمئن هستید که می خواهید حذف کنید؟")) {
                            $.ajax({
                                type:'POST',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/edogroup/edosale.edogroup.ir/resources/views/sale/index.blade.php ENDPATH**/ ?>